...
echo ""
echo ""
read -p $'\e[1;32m\e[0m\e[1;32mTHIS TOOL IS FOR EDUCATIONAL PURPOSES ONLY ? \e[1;33m\e[0m\e[1;33m (Y/N) : \e[0m' option
echo""
echo""
echo""
		 ...
		 case $option in
			 1) cd paytm/
               ...
               28)cd sites/
                ...
                99)echo -e $'\e[1;32m[\e[0m\e[1;77m+\e[0m\e[1;32m]\e[0m\e[1;33m                                                         >>SUBSCRIBE US & ALSO JOIN US ON DISCORD >> \e[0m'
                   sleep 1
                   exit
                ;;
